"""Integration tests for Context Engineering - Building the Context Assembly Pipeline.
...
def test_02_assembly_pipeline(raw_client):
    """Run all code blocks from: Building the Context Assembly Pipeline."""
